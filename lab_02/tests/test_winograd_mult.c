...
START_TEST(incorrect_matrix_ptr_in_winograd_mult) {
#define M 3
#define K 4
    data_t b = {{2, 0, 0}, {1, 2, 3}, {0, 1, 2}, {1, 2, 2}};
    matrix_t *mb = init_matrix_by_array(K, M + 1, b);

    matrix_t *res = winograd_matrix_mult(NULL, mb);
...
START_TEST(incorrect_size_winograd_matrix_mult) {
#define N 2
#define M 3
#define K 4
    ...
    matrix_t *res = winograd_matrix_mult(ma, mb);
...
START_TEST(row_winograd_matrix_mult) {
#define N 2
    data_t a = {{1, 2}};
    data_t b = {{3, 4}, {5, 6}};
...
START_TEST(square_matrix_column_winograd_mult) {
#define N 2
    data_t a = {{1, 2}, {3, 4}};
    data_t b = {{2}, {1}};
...
START_TEST(column_matrix_row_winograd_mult) {
#define N 2
    data_t a = {{1, 2}};
    data_t b = {{2}, {1}};
    matrix_t *ma = init_matrix_by_array(1, N, a);
...
START_TEST(square_matrix_identity_winograd_mult) {
#define N 2
    data_t a = {{1, 2}, {3, 4}};
    data_t b = {{1, 0}, {0, 1}};
    matrix_t *ma = init_matrix_by_array(N, N, a);
...
START_TEST(rectangular_winograd_matrix_mult_res_square) {
#define N 2
#define M 3
    data_t a = {{1, 2, 3}, {4, 5, 6}};
...
START_TEST(rectangular_winograd_matrix_mult_res_rectangular) {
#define N 2
#define M 3
    data_t a = {{1, 2, 3}, {4, 5, 6}};
...
START_TEST(first_ord_square_winograd_matrix_mult) {
#define N 1
    data_t a = {{2}};
    data_t b = {{3}};
    matrix_t *ma = init_matrix_by_array(N, N, a);
...
START_TEST(square_winograd_matrix_mult) {
#define N 2
    data_t a = {{1, 2}, {3, 4}};
    data_t b = {{2, 0}, {1, 2}};
    matrix_t *ma = init_matrix_by_array(N, N, a);
...
Suite* winograd_mult_suite(void) {
    ...
    tcase_add_test(tc_neg, incorrect_matrix_ptr_in_winograd_mult);
    tcase_add_test(tc_neg, incorrect_size_winograd_matrix_mult);
    suite_add_tcase(s, tc_neg);

    // Положительные тесты
    tc_pos = tcase_create(" positives ");
    tcase_add_test(tc_pos, row_winograd_matrix_mult);
    tcase_add_test(tc_pos, square_matrix_column_winograd_mult);
    tcase_add_test(tc_pos, column_matrix_row_winograd_mult);
    tcase_add_test(tc_pos, rectangular_winograd_matrix_mult_res_rectangular);
    tcase_add_test(tc_pos, square_matrix_identity_winograd_mult);
    tcase_add_test(tc_pos, rectangular_winograd_matrix_mult_res_square);
    tcase_add_test(tc_pos, first_ord_square_winograd_matrix_mult);
    tcase_add_test(tc_pos, square_winograd_matrix_mult);
